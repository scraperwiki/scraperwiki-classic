...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.ssh_public_key'
        db.add_column('frontend_userprofile', 'ssh_public_key', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.ssh_public_key'
        db.delete_column('frontend_userprofile', 'ssh_public_key')
